            ...
            for (idx,m) in self.activeList.enumerated() {
                switch idx {
                    case 0:
                        ...
                        if let url = URL.init(string: ZXAPI.file(address: m.icon)) {
                            self.active1Icon.kf.setImage(with: url, placeholder: UIImage.Default.empty)
                        }
                    ...
                    case 1:
                        ...
                        if let url = URL.init(string: ZXAPI.file(address: m.icon)) {
                            self.active2Icon.kf.setImage(with: url, placeholder: UIImage.Default.empty)
                        }
                        if let url = URL.init(string: ZXAPI.file(address: m.image)) {
