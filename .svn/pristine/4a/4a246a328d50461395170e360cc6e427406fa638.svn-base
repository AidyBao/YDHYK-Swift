...
class ZXBalanceCouponCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.lbLeftDot.backgroundColor = UIColor.zx_subTintColor
        
        self.lbRightDot.layer.cornerRadius = 5
        self.lbRightDot.layer.masksToBounds = true
        self.lbRightDot.backgroundColor = UIColor.zx_subTintColor
        
        self.topInfoView.backgroundColor = UIColor.zx_customCColor
        ...
        self.lbGroupName.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 1)
        
        self.lbFullMoneyInfo.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 1)
        self.lbValidDateInfo.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 1)
        
        self.lbCouponPriceInfo.font = UIFont.zx_titleFont(UIFont.zx_subTitleFontSize)
    ...
    func reloadData(coupon: ZXOrderCouponModel?) {
        ...
        if let coupon = coupon {
            if let url = coupon.url {
                self.imgGroupIcon.kf.setImage(with: url, placeholder: UIImage.Default.empty)
            } else {
