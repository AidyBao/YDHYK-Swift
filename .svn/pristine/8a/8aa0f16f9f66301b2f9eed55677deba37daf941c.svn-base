...
class ZXImageCropperViewController: ZXUIViewController {
    ...
    func initControlBtn() {
        ...
        cancelBtn.addTarget(self, action: #selector(ZXImageCropperViewController.cancel(_:)), for: UIControlEvents.touchUpInside)
        ...
        confirmBtn.addTarget(self, action: #selector(ZXImageCropperViewController.confirm(_:)), for: UIControlEvents.touchUpInside)
