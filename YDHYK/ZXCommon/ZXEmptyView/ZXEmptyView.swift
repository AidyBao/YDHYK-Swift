...
class ZXEmptyView: UIView {
    ...
    @discardableResult class func show(in view:UIView!,type:ZXEnumEmptyType,text:String?,retry callBack:ZXClosure_Empty? = nil) -> ZXEmptyView? {
        if let view = view {
            self.hide(from: view)
    ...
    override init(frame: CGRect) {
        ...
        lbInfo.font = UIFont.zx_titleFont(14)
