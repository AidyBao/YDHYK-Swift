...
extension UIScrollView {
    func zx_addHeaderRefresh(showGif:Bool,target:Any!,action:Selector!) {
        if showGif {
            let header:ZXRefreshHeader = ZXRefreshHeader(refreshingTarget: target, refreshingAction: action)
