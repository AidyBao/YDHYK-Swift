...
class ZXTextView: UIView, UITextViewDelegate {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        if characterNum > limitTextNum {
            ...
            ZXHUD.showFailure(in: (UIApplication.shared.keyWindow?.rootViewController?.view)!, text: String.init(format: "输入字符长度不能大于%d！",limitTextNum), delay: ZX.HUDDelay)
        }
    ...
    func textView(_ textView: UITextView, shouldChangeTextIn range: NSRange, replacementText text: String) -> Bool {
        ...
        let replaceLength:Int = text.count
