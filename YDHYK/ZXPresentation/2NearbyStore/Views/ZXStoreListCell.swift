...
class ZXStoreListCell: UITableViewCell {
    ...
    @IBOutlet weak var joinBtn: ZXUIButton!
    ...
    override func awakeFromNib() {
        ...
        self.buyBtn.backgroundColor = UIColor.white
        self.buyBtn.setTitleColor(UIColor.zx_tintColor, for: .normal)
        self.buyBtn.titleLabel?.font = UIFont.zx_titleFont(14.0)
    ...
    func loadData(_ mode: ZXSearchModel) {
        ...
        self.icon.kf.setImage(with: URL.init(string:mode.headPortraitStr), placeholder: UIImage.Default.empty, options: nil, progressBlock: nil, completionHandler: nil)
