...
class ZXTakeOrderSuccessCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.btnReviewOrder.setTitleColor(UIColor.zx_textColorMark, for: .normal)
        self.btnReviewOrder.layer.borderColor = UIColor.zx_textColorMark.cgColor
        self.btnReviewOrder.layer.borderWidth = 0.5
        self.btnReviewOrder.layer.cornerRadius = 5
        
        self.btnPopToRoot.setTitleColor(UIColor.zx_textColorMark, for: .normal)
        self.btnPopToRoot.layer.borderColor = UIColor.zx_textColorMark.cgColor
