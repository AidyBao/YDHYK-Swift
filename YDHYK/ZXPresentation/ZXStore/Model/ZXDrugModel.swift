...
/// 药品库 药品列表Model
@objcMembers class ZXDrugModel: NSObject {
    var drugstoreId: String = ""
    //var drugId:Int32 = 0       //柜台药品id
    var baseDrugId: String = "" //基础药品id
    var drugName:String = ""
    ...
    var zx_imageUrl: URL? {
        if let path = attachFilesStrs.first, let url = URL.init(string: ZXAPI.file(address: path)) {
            return url
        }
        return nil
    }
...
@objcMembers class ZXDrugSpecModel:NSObject {
    var name = ""
    var price = ""
    ...
    var size:CGSize {
        get{
            var rect = name.zx_textRectSize(toFont: UIFont.zx_titleFont(UIFont.zx_bodyFontSize - 1), limiteSize: CGSize(width: ZXBOUNDS_WIDTH - 28, height: CGFloat.greatestFiniteMagnitude))
...
/// 药品详情Model
@objcMembers class ZXDrugDetailModel: NSObject {
    //var drugId: String = ""  //柜台药品id
    var baseDrugId: String = "" //基础药品id
    var groupId: String = ""
    var groupName:String = ""
    var drugstoreId: String = ""
    var drugstoreName:String = ""
    var groupDrugId: String = ""
    var drugName:String = ""
