...
class ZXActive3: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.active1Title.textColor = UIColor.zx_textColorTitle
        self.active1Title.font = UIFont.boldSystemFont(ofSize: UIFont.zx_bodyFontSize)
        
        self.active1SubTitle.text = ""
        self.active1SubTitle.textColor = UIColor.zx_tintColor
        self.active1SubTitle.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 2)
        
        self.active2Title.text = ""
        self.active2Title.textColor = UIColor.zx_textColorTitle
        self.active2Title.font = UIFont.boldSystemFont(ofSize: UIFont.zx_bodyFontSize)
        
        self.active2SubTitle.text = ""
        self.active2SubTitle.textColor = UIColor(red: 142 / 255.0, green: 216 / 255.0, blue: 79 / 255.0, alpha: 1.0)
        self.active2SubTitle.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 2)
        
        self.active3Title.text = ""
        self.active3Title.textColor = UIColor.zx_textColorTitle
        self.active3Title.font = UIFont.boldSystemFont(ofSize: UIFont.zx_bodyFontSize)
        
        self.active3SubTitle.text = ""
        self.active3SubTitle.textColor = UIColor(red: 235 / 255.0, green: 196 / 255.0, blue: 76 / 255.0, alpha: 1.0)
        self.active3SubTitle.font = UIFont.zx_bodyFont(UIFont.zx_bodyFontSize - 2)
            ...
            for (idx,m) in self.activeList.enumerated() {
                switch idx {
                    case 0:
                        ...
                        if let url = URL.init(string: ZXAPI.file(address: m.image)) {
                            self.active1Image.kf.setImage(with: url, placeholder: UIImage.Default.empty)
                        }
                    case 1:
                        self.active2Title.text = m.title
                        self.active2SubTitle.text = m.subTitle
                        if let url = URL.init(string: ZXAPI.file(address: m.image)) {
                            self.active2Image.kf.setImage(with: url, placeholder: UIImage.Default.empty)
                        }
                    case 2:
                        self.active3Title.text = m.title
                        self.active3SubTitle.text = m.subTitle
                        if let url = URL.init(string: ZXAPI.file(address: m.image)) {
                            self.active3Image.kf.setImage(with: url, placeholder: UIImage.Default.empty)
                        }
                    default:
                        break
                }
