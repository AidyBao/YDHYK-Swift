...
class ZXActive1Cell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.lbName.font = UIFont.boldSystemFont(ofSize: UIFont.zx_bodyFontSize)
        self.btnSeeMore.setTitleColor(UIColor.zx_tintColor, for: .normal)
...
extension ZXActive1Cell: UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let width = floor((ZXBOUNDS_WIDTH - 40) / 3)
